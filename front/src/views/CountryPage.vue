...
const countriesData = {
  uzbekistan: {
    ...
    intro:
      'Узбекистан объединяет древние города Шелкового пути, яркую архитектуру, гастрономию и удобную логистику для культурных маршрутов.',
    ...
    sections: [
      {
        ...
        text: 'Узбекистан подходит для насыщенных культурных программ с Самаркандом, Бухарой, Хивой, Ташкентом и региональными маршрутами.',
      },
      {
        id: 'cuisine',
        title: 'Кухня Узбекистана',
        text: 'Кухня Узбекистана известна пловом, самсой, лагманом, шашлыком, лепешками, сезонными фруктами и восточными сладостями.',
      },
      {
        id: 'visa',
        title: 'Виза в Узбекистан',
        text: 'Визовые правила зависят от гражданства туриста и длительности пребывания, поэтому условия нужно проверять перед поездкой.',
      },
      {
        id: 'map',
        title: 'Карта Узбекистана',
        text: 'Основные маршруты проходят через Ташкент, Самарканд, Бухару, Хиву, Ферганскую долину и пустынные локации.',
      },
      {
        id: 'currency',
        title: 'Валюта Узбекистана',
        text: 'Основная валюта страны - узбекский сум.',
      },
      {
        id: 'safety',
        title: 'Безопасность',
        text: 'Для комфортной поездки рекомендуем заранее согласовать сезон, переезды, отели и экскурсионную программу.',
      },
    ],
  },
  kazakhstan: {
    ...
    intro:
      'Казахстан сочетает современные города, степные ландшафты и богатую культурную программу для путешествий по Центральной Азии.',
    ...
    sections: [
      {
        ...
        text: 'Казахстан подходит для маршрутов с природой, городскими экскурсиями, гастрономией и комфортной логистикой.',
      },
      {
        id: 'cuisine',
        title: 'Кухня Казахстана',
        text: 'Кухня Казахстана строится вокруг мясных блюд, выпечки, молочных продуктов и гостеприимных застолий.',
      },
      {
        id: 'visa',
        title: 'Виза в Казахстан',
        text: 'Визовые требования зависят от гражданства туриста и сроков поездки, поэтому условия нужно проверять перед бронированием.',
      },
      {
        id: 'map',
        title: 'Карта Казахстана',
        text: 'Маршруты могут включать Алматы, Астану, Туркестан, природные парки и озера.',
      },
      {
        id: 'currency',
        title: 'Валюта Казахстана',
        text: 'Основная валюта страны - казахстанский тенге.',
      },
      {
        id: 'safety',
        title: 'Безопасность',
        text: 'Для комфортной поездки рекомендуем заранее согласовать маршрут, транспорт и сезонные особенности.',
      },
    ],
  },
  kyrgyzstan: {
    ...
    intro: 'Кыргызстан известен горными пейзажами, озером Иссык-Куль, кочевой культурой и активными маршрутами.',
    ...
    sections: [
      { id: 'why', title: 'Почему Кыргызстан?', text: 'Направление подходит для горных программ, этнотуров и комбинированных поездок по Центральной Азии.' },
      { id: 'cuisine', title: 'Кухня Кыргызстана', text: 'В меню часто встречаются бешбармак, лагман, манты, лепешки и традиционные молочные продукты.' },
      { id: 'visa', title: 'Виза в Кыргызстан', text: 'Правила въезда зависят от гражданства и длительности поездки, поэтому их лучше уточнять заранее.' },
      { id: 'nature', title: 'Природа Кыргызстана', text: 'Главные акценты - горы Тянь-Шаня, ущелья, альпийские озера и маршруты у Иссык-Куля.' },
      { id: 'currency', title: 'Валюта Кыргызстана', text: 'Основная валюта страны - кыргызский сом.' },
      { id: 'safety', title: 'Безопасность', text: 'Комфорт поездки зависит от сезона, высоты маршрута и заранее согласованной логистики.' },
    ],
  },
  tajikistan: {
    heroImage: '/assets/icons/countryPage2.webp',
    ...
    intro: 'Таджикистан привлекает горными маршрутами, древними городами и программами по Памирскому тракту.',
    ...
    sections: [
      { id: 'why', title: 'Почему Таджикистан?', text: 'Это направление для путешественников, которым важны горы, история и редкие маршруты.' },
      { id: 'cuisine', title: 'Кухня Таджикистана', text: 'Традиционная кухня включает плов, курутоб, супы, лепешки и блюда из мяса и овощей.' },
      { id: 'visa', title: 'Виза в Таджикистан', text: 'Условия въезда и разрешения на отдельные регионы нужно проверять перед поездкой.' },
      { id: 'pamir', title: 'Памирский тракт', text: 'Памирский тракт - один из самых выразительных горных маршрутов региона.' },
      { id: 'currency', title: 'Валюта Таджикистана', text: 'Основная валюта страны - таджикский сомони.' },
      { id: 'safety', title: 'Безопасность', text: 'Для горных маршрутов особенно важны подготовленная логистика, транспорт и сопровождение.' },
    ],
  },
  caucasus: {
    heroImage: '/assets/icons/countryPage.webp',
    ...
    intro: 'Кавказ объединяет яркие города, горные пейзажи, кухню и насыщенные культурные маршруты.',
    ...
    sections: [
      { id: 'why', title: 'Почему Кавказ?', text: 'Регион удобен для комбинированных туров с природой, архитектурой, вином и гастрономией.' },
      { id: 'cuisine', title: 'Кухня Кавказа', text: 'Кухня региона разнообразна: хачапури, шашлык, долма, супы, сыры, зелень и местные вина.' },
      { id: 'visa', title: 'Виза на Кавказ', text: 'Правила въезда отличаются по странам маршрута и требуют предварительной проверки.' },
      { id: 'nature', title: 'Природа Кавказа', text: 'Маршруты могут включать горы, ущелья, виноградники, побережье и исторические города.' },
      { id: 'currency', title: 'Валюта', text: 'Валюта зависит от страны маршрута, поэтому условия оплаты лучше уточнять до поездки.' },
      { id: 'safety', title: 'Безопасность', text: 'Для комфортного тура важно заранее согласовать переезды, границы и сезонность маршрута.' },
    ],
  },
};
